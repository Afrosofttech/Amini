<?php include 'includes/header.php';?>
 ...
 <div class="row">
	 ...
	 <h2>Amini Centre for policy Research</h2>
		 <h3>Be a content creator</h3>
		</div>
 		...
 		<div class="col-xs-4">
				...
				<div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="register" style="background: red;">Register</button>
 			</form>
