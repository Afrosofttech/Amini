 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">AMINI ADMIN PANEL</a>
            </div>
                ...
                <ul class="nav navbar-nav side-nav">
                   ...
                   <li>
                        ...
                        <ul id="posts" class="collapse">
                            <li>
                                <a href="./posts.php"><i class="fa fa-circle-o"></i> View All Posts</a>
                            </li>
                            <li>
                                <a href="./publishnews.php"><i class="fa fa-circle-o"></i> Add New Post</a>
                            </li>
                        </ul>
                        <li>
                        ...
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./users.php"><i class="fa fa-circle-o"></i> View All Users</a>
                            </li>
                            <li>
                                <a href="adduser.php"><i class="fa fa-circle-o"></i> Add New User</a>
                            </li>
                        </ul>
                    </li>
                    <li>
