...
window.location.href='./index.php'; </script>";
    ...
    <tbody>
        ...
        <?php 
            ...
            echo "<td><a href='users.php?change_to_admin=$user_id''><span class='badge badge-secondary'>Make Admin</span></a></td>";
                echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this user?')\" href='users.php?delete=$user_id'><i class='fa fa-times fa-2x' style='color: red;'></i></a></td>";
                echo "</tr>";
             }
        ?>
